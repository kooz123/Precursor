...
int
unjail2(uint64_t allproc, uint64_t credpatch, int action)
{
    ...
    *(uint64_t *)&mem.uuid[8] = 0xabadbabeabadbabe;
    ...
    rv = grab_hashes("/Applications", kread, amficache, mem.next);
    rv = grab_hashes("/Library", kread, amficache, mem.next);
    rv = grab_hashes("/System", kread, amficache, mem.next);
